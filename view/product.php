...
<div class="d-flex flex-row justify-content-between align-items-center">
    <h1 class="fw-bold fs-2 m-3 text-center"><span id="productDataProcessType">Add</span> Product Details </h1>
    <div>
        <button class="btn btn-dark btn-sm rounded-pill px-3" onclick="crudProductdata()"><span id="btnStatus">Update</span></button>
    </div>
</div>

<div class="d-flex flex-row justify-content-center align-items-center d-none" id="selectProductForUD">
    <!-- student select -->
        ...
        <div class="col-12 col-md-8 d-flex flex-column">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="col-12 mx-auto d-flex flex-column justify-content-center my-5">
                    <button class="btn btn-lg btn-dark rounded-pill mx-5 px-3" id="productAddBtnSection" onclick="addProduct()">Add Product</button>
                </div>
                ...
                <div class="col-12 mx-auto d-flex flex-column justify-content-center my-3 d-none" id="productUDbtnSection">
